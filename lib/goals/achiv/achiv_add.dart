...
class AchivAdd extends StatefulWidget {
  const AchivAdd({super.key});

  @override
  State<AchivAdd> createState() => _AchivAddState();
}

class _AchivAddState extends State<AchivAdd> {
          ...
          child: Column(
            children: [
              ...
              InkWell(
                onTap: () async {
                  if (continueColor) {
                    AchivHiveModel achivHiveModel = AchivHiveModel(
                      id: DateTime.now().millisecondsSinceEpoch,
                      name: _controllerName.text,
                      description: _controllerDescription.text,
                      image: photo!,
                    );
                    await AchivRepoImpl().setAchiv(achivHiveModel);
